...
Autogenerated ORCID client

## Contents

- [orcid-client](#orcid-client)
  - [Contents](#contents)
...
```sh
yarn add orcid-client
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install orcid-client
```
...
[orcid-client]: https://github.com/journaloftrialanderror/jote/tree/main/libs/orcid-client
