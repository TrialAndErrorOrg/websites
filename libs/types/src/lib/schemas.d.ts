...
export interface ApiApplicationApplication extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    state: EnumerationAttribute<
      ['submitted', 'responded', 'draft', 'accepted', 'rejected']
    > &
      DefaultTo<'submitted'>;
    name: StringAttribute & RequiredAttribute;
    start: DateAttribute;
...
export interface ApiJoteArticleCategoryJoteArticleCategory
...
export interface ApiOpenPositionOpenPosition extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: EnumerationAttribute<
      ['internship', 'volunteer', 'part-time', 'full-time']
    > &
      SetPluginOptions<{
        i18n: {
          localized: true;
