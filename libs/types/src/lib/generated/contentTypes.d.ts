...
export interface PluginSlugifySlug extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'plugin::slugify.slug', 'oneToOne', 'admin::user'> &
      Attribute.Private
    updatedBy: Attribute.Relation<'plugin::slugify.slug', 'oneToOne', 'admin::user'> &
      Attribute.Private
    sitemap_exclude: Attribute.Boolean & Attribute.Private & Attribute.DefaultTo<false>
  }
}
...
export interface ApiUpdateCategoryUpdateCategory extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required
    symbol: Attribute.Media & Attribute.Required
    in: Attribute.String
