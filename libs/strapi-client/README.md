# @trialanderror/strapi

Typed REST Client for Strapi v4.3+

## Contents

- [@trialanderror/strapi](#@trialanderror/strapi)
  - [Contents](#contents)
...
```sh
yarn add @trialanderror/strapi
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install @trialanderror/strapi
```
...
[@trialanderror/strapi]: https://github.com/journaloftrialanderror/jote/tree/main/libs/@trialanderror/strapi
