# next-auth-orcid-provider

NextAuth for authenticating with ORCID

## Contents

- [next-auth-orcid-provider](#next-auth-orcid-provider)
  - [Contents](#contents)
...
```sh
yarn add next-auth-orcid-provider
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install next-auth-orcid-provider
```
...
[next-auth-orcid-provider]: https://github.com/journaloftrialanderror/jote/tree/main/libs/next-auth-orcid-provider
