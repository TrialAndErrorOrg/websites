...
export function _normalizeData(data: any): any {
	const isObject = (data2: any) =>
		Object.prototype.toString.call(data2) === "[object Object]";
...
export const getPostsByDeep = cache(async (slug: string) => {
	const post = await getPostBase()
		.filterDeep("blog_tags.slug", "eq", slug)
		.get();
...
export const getPostBy = cache(
	async ({
		...
		const post = await getPostBase(draftMode)
			.populateWith("body")
			.equalTo(field, value)
			.get();
...
export const getSinglePost = async (slug: string, draftMode = false) => {
	const data = await fetch(
		`${
			env.STRAPI_ENDPOINT
		}/blog-posts?populate[blog_tags][populate]=&populate%5Bteam_members%5D%5Bfields%5D%5B0%5D=firstName&populate%5Bteam_members%5D%5Bfields%5D%5B1%5D=lastName&populate%5Bteam_members%5D%5Bfields%5D%5B2%5D=slug&populate%5Bteam_members%5D%5Bfields%5D%5B3%5D=position&populate%5Bteam_members%5D%5Bfields%5D%5B4%5D=orcid&populate%5Bteam_members%5D%5Bfields%5D%5B5%5D=bluesky&populate%5Bteam_members%5D%5Bfields%5D%5B6%5D=github&populate%5Bteam_members%5D%5Bfields%5D%5B7%5D=linkedin&populate%5Bteam_members%5D%5Bfields%5D%5B8%5D=personalWebsite&populate%5Bteam_members%5D%5Bfields%5D%5B9%5D=summary&populate%5Bteam_members%5D%5Bfields%5D%5B10%5D=mastodon&populate%5Bteam_members%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B0%5D=url&populate%5Bteam_members%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B1%5D=formats&populate%5Bteam_members%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B2%5D=alternativeText&populate%5Bteam_members%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B3%5D=height&populate%5Bteam_members%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B4%5D=width&populate%5Bblog_authors%5D%5Bfields%5D%5B0%5D=firstName&populate%5Bblog_authors%5D%5Bfields%5D%5B1%5D=lastName&populate%5Bblog_authors%5D%5Bfields%5D%5B2%5D=slug&populate%5Bblog_authors%5D%5Bfields%5D%5B3%5D=orcid&populate%5Bblog_authors%5D%5Bfields%5D%5B4%5D=bluesky&populate%5Bblog_authors%5D%5Bfields%5D%5B5%5D=github&populate%5Bblog_authors%5D%5Bfields%5D%5B6%5D=linkedIn&populate%5Bblog_authors%5D%5Bfields%5D%5B7%5D=personalWebsite&populate%5Bblog_authors%5D%5Bfields%5D%5B8%5D=summary&populate%5Bblog_authors%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B0%5D=url&populate%5Bblog_authors%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B1%5D=formats&populate%5Bblog_authors%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B2%5D=alternativeText&populate%5Bblog_authors%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B3%5D=height&populate%5Bblog_authors%5D%5Bpopulate%5D%5Bimage%5D%5Bfields%5D%5B4%5D=width&populate[image][populate]=&populate[category][populate]=&filters[slug][$eq]=${slug}${
			draftMode ? "&publicationState=preview" : ""
		}`,
		{
			headers: {
