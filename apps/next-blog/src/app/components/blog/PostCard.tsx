        ...
        <div className={className}>
            <div
				className={cx(
					...
					"relative",
					wide
						? "border-b-2 md:w-1/2 md:border-b-0 md:border-r-2"
						: "border-b-2",
				)}
			>
				{post.image ? (
					<Image
						...
						height={
							(wide
								? (post.image?.formats?.large?.height ??
									post.image?.formats?.medium?.height)
								: post.image?.formats?.medium?.height) ?? post.image.height
						}
						width={
							(wide
								? (post.image?.formats?.large?.width ??
									post.image?.formats?.medium?.width)
