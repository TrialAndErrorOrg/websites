			...
			<div className="mx-auto px-4 py-12 sm:px-6 md:max-w-7xl lg:px-8 lg:py-16 xl:max-w-[100rem]">
				<div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
					<div className="grid grid-cols-2 flex-wrap gap-4 md:flex md:gap-8 xl:col-span-4">
						{new Array(Math.floor(((footer?.length ?? 0) - 0.1) / 2) + 1)
							.fill(0)
							.map((_, idx) => (
								<div
									key={_ + idx}
								...
								>
									{[footer?.[idx * 2], footer?.[idx * 2 + 1]]?.map(
										(section, ix) => (
											<div
				...
				<div className="lg:items-top flex flex-col gap-4 border-t border-white pt-8 dark:border-white lg:flex-row lg:justify-between xl:mt-0">
					<p className="max-w-2xl flex-shrink">
						Do you have an idea or draft for a piece that might suit the themes
						of this blog? The blog of Trial & Error appreciates all suggestions
						and can help you develop and edit your proposal or draft. You can
						contact editor-in-chief Marcel Hobma with your idea via{" "}
						<a
