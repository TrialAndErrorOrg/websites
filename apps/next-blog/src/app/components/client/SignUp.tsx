    ...
    <>
      ...
      >
        ...
        <input
          ...
          // required
          className="w-full min-w-0 appearance-none rounded-full border-2 border-black bg-white px-4 py-2 text-base font-semibold text-gray-900 placeholder-gray-900 focus:border-orange-500 focus:placeholder-gray-400 focus:outline-none focus:ring-orange-500 dark:text-white sm:max-w-xs"
