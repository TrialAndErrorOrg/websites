...
import { instantMeiliSearch, MultiSearchResult } from '@meilisearch/instant-meilisearch'
...
export function SearchModal({
  ...
  const results = res as unknown as MultiSearchResult<MeiliSearchBlogPostResult>
