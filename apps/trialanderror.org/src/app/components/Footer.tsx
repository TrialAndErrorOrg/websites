...
import type { EasyMenu } from "@/types";
...
const defaultNav: EasyMenu = {
	...
	items: [
		...
		{
			title: "Company",
			children: [{ title: "Jobs", url: "https://positions.trialanderror.org" }],
		},
		{
			title: "Legal",
			children: [
...
const defaultSocials: EasyMenu = {
	...
	items: [
		{
			title: "Bluesky",
			url: "https://bsky.app/profile/trialanderror.org",
		},
		{
			title: "GitHub",
...
export async function Footer() {
	...
	return (
		<footer
			className="z-1 relative bg-blue-500"
              ...
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                ...
                /> */}
					...
					<p className="mt-8 text-base text-slate-100 md:order-1 md:mt-0">
						&copy; {new Date().getFullYear()} Center of Trial and Error. CC BY
						4.0
					</p>
				</div>
			</div>
