      ...
      <Dialog as="div" className="fixed inset-0 z-50 overflow-y-auto" onClose={setOpen}>
        <div className="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            ...
            > */}
            <div className="relative inline-block max-w-xl transform overflow-hidden border-2 border-black bg-white px-6 pt-5 pb-4 text-left align-bottom  shadow-thick-3 transition-all sm:my-8 sm:w-full sm:p-6 sm:align-middle">
              {/* </div> */}
              ...
              {isSubmitted && isSubmitSuccessful ? (
                ...
                <form
                  ...
                  className="validate prose py-4 text-left font-medium !text-black md:prose-lg"
                  target="_self"
                >
                  <div
