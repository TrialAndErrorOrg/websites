import { getProjects, names, joinPathFragments, Tree } from '@nrwl/devkit'
import { Schema } from '@nrwl/react/src/generators/component/schema'
...
export async function getDirectory(host: Tree, options: Schema) {
  ...
  const fileName = options.pascalCaseDirectory === true ? genNames.className : genNames.fileName
