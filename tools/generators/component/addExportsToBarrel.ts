import { Tree, getProjects, joinPathFragments, applyChangesToString } from '@nrwl/devkit'
...
export function addExportsToBarrel(
  host: Tree,
  options: { project: string; export: boolean; projectSourceRoot: string; directory: string },
) {
